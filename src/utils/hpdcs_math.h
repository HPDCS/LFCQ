...
extern double zipf_rand(struct drand48_data *seed, double exp);
extern double zipf_compile_time_rand(struct drand48_data *seed, double exp);
extern double pareto_compile_time_rand(struct drand48_data *seed, double mean);
