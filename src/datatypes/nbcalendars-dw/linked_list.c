...
dwb* new_node(unsigned long long, dwb*, bool, unsigned int);
...
dwb* new_node(unsigned long long index_vb, dwb *next, bool allocate_dwv, unsigned int numa_node){
	int i;
...
dwb* list_add(dwb *head, unsigned long long index_vb, int numa_node, dwb* list_tail){
