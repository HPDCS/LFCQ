...
protected://types
	...
	public:
		...
		static Node* getNewNode(final pkey_t inKey) {
		...
		static Node* getNewNode(final pkey_t inKey, final int height) {
...
protected://methods
	...
	inline_ Node* find(final pkey_t key) {
		Node* pPred;
		Node* pCurr;
		pPred = _head;
...
public://methods
	...
	boolean add2(final int iThread, final pkey_t inValue) {
		SlotInfo* my_slot = _tls_slot_info;
		if(null == my_slot)
			my_slot = get_new_slot();

		SlotInfo* volatile&	my_next = my_slot->_next;
		pkey_t volatile& my_re_ans = my_slot->_req_ans;
		my_re_ans = inValue;
	...
	//deq ......................................................
	pkey_t remove2(final int iThread) {
		SlotInfo* my_slot = _tls_slot_info;
		if(null == my_slot)
			my_slot = get_new_slot();
