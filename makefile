...
SRC_DIR := src
TARGETS := NUMAP NUMAPNOP NBCQ UNBCQ NUMAFK #NUMAPNOP# UNBCQ NUMAPNOP NUMAPBL NUMAQ#LIND MARO CBCQ SLCQ NBVB 2CAS NRTM VBPQ UNBCQ NUMAQ NUMAFK NUMAP #V2CQ NUMA WORK
