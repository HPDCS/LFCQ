...
SRC_DIR := src
TARGETS := LIND ACRCQ NUMAP RNUMAP NUMAPFK NUMAPBL NUMAPSKT RNUMAPSKT NUMAPSKTFK NUMAPSKTBL NUMAQ RNUMAQ NUMAQFK NUMAQBL NUMAQSKT RNUMAQSKT NUMAQSKTFK NUMAQSKTBL NUMA2Q RNUMA2Q NUMA2QFK NUMA2QBL NUMA2QSKT RNUMA2QSKT NUMA2QSKTFK NUMA2QSKTBL NBNUMAQ NBRNUMAQ NBNUMAQSKT NBRNUMAQSKT NBNUMA2Q NBRNUMA2Q NBNUMA2QSKT NBRNUMA2QSKT NBNUMAP NBRNUMAP NBNUMAPSKT NBRNUMAPSKT ACRCQH

		# CACRCQ ACRCQH	
		# SCNUMAP SCNUMAPFK NUMAPNBC NUMAPNBCFK NUMAPNBCBL
		#NBCQ LIND MARO CBCQ SLCQ NBVB 2CAS VBPQ ACRCQ #V2CQ NUMA WORK
...
######################################################## TODOOOOOOOO As soon as possible
...
NBRNUMAP_value := src/datatypes/nb_umb/nb/numap/base_r.o src/datatypes/nb_umb/nb/numap/mapping_nb.o $(UTIL_value) $(ARCH_value) $(NGACO_value)
NBRNUMAP_link := gcc

## NUMAQ

NBNUMAQ_value := $(TQ_value) src/datatypes/nb_umb/nb/numaq/base.o $(UTIL_value) $(ARCH_value) $(NGACO_value)
NBNUMAQ_link := gcc

NBRNUMAQ_value := $(TQ_value) src/datatypes/nb_umb/nb/numaq/base_r.o $(UTIL_value) $(ARCH_value) $(NGACO_value)
NBRNUMAQ_link := gcc

## NUMA2Q

NBNUMA2Q_value := $(TQ_value) src/datatypes/nb_umb/nb/numa2q/base.o src/datatypes/nb_umb/nb/numa2q/enq_sw_cache.o src/datatypes/nb_umb/nb/numa2q/sw_cache.o $(UTIL_value) $(ARCH_value) $(NGACO_value)
NBNUMA2Q_link := gcc

NBRNUMA2Q_value := $(TQ_value) src/datatypes/nb_umb/nb/numa2q/base_r.o src/datatypes/nb_umb/nb/numa2q/enq_sw_cache.o src/datatypes/nb_umb/nb/numa2q/sw_cache.o $(UTIL_value) $(ARCH_value) $(NGACO_value)
NBRNUMA2Q_link := gcc

## NUMAP + SKT

NBNUMAPSKT_value := src/datatypes/nb_umb/nb/numap_socket/base.o src/datatypes/nb_umb/nb/numap_socket/mapping_nb.o $(UTIL_value) $(ARCH_value) $(NGACO_value)
NBNUMAPSKT_link := gcc

NBRNUMAPSKT_value := src/datatypes/nb_umb/nb/numap_socket/base_r.o src/datatypes/nb_umb/nb/numap_socket/mapping_nb.o $(UTIL_value) $(ARCH_value) $(NGACO_value)
NBRNUMAPSKT_link := gcc

## NUMAQ + SKT

NBNUMAQSKT_value := $(TQ_value) src/datatypes/nb_umb/nb/numaq_socket/base.o $(UTIL_value) $(ARCH_value) $(NGACO_value)
NBNUMAQSKT_link := gcc

NBRNUMAQSKT_value := $(TQ_value) src/datatypes/nb_umb/nb/numaq_socket/base_r.o $(UTIL_value) $(ARCH_value) $(NGACO_value)
NBRNUMAQSKT_link := gcc
