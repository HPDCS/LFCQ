...
SRC_DIR := src
TARGETS := NUMAFK NUMAQ NUMAFKBL UNBCQ NBCQ NUMAP NUMAPNOP NUMAPBL NUMAQBLK #LIND MARO CBCQ SLCQ NBVB 2CAS NRTM VBPQ UNBCQ NUMAQ NUMAFK NUMAP #V2CQ NUMA WORK
