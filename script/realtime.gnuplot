...
plot for [col=start:end] file using 1:(column(col)/1000) with lines ls col t columnheader
...
#plot for [col=start:4] file using 1:(column(col)/1000) with lines ls col t columnheader
#system(sprintf("epstopdf %s", outfile)) 
