...
# cmd parameters
##############################
# NBCQ UNBCQ NUMA2Q NUMA2QBL NUMAP NUMAQ NUMAQBLK NUMAPSKT
# NUMAQ NUMAQBLK NUMAP NUMAPSKT NUMAPNBC NUMAPFNB NUMA2Q NUMA2QBLK 
...
data_types="ACRCQ NUMAFK NUMAFKBL NUMAPNOP NUMAPBL NUMAPSKTFK NUMAPSKTBL NUMAPNBCBL NUMAPNBCFK NUMA2QFK NUMA2QBL" #"ACRCQ NUMA2Q NUMA2QFK NUMA2QBL NUMAP NUMAPNOP NUMAPBL NUMAQ NUMAFK NUMAFKBL NUMAQBLK NUMAPSKT NUMAPSKTFK NUMAPSKTBL"
