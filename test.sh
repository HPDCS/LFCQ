...
then
    ...
    #PRE1="perf stat -e L1-dcache-load-misses,L1-dcache-loads,L1-dcache-stores,L1-dcache-store-misses"
    #PRE2="LLC-loads,LLC-load-misses,LLC-stores,node-loads,node-load-misses,node-stores,node-store-misses"
else
    PRE=""
fi
